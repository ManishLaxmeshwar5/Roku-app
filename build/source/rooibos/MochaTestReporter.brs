...
function rooibos_reporters_mocha_new_Diff()
    return {
        ...
        execEditLength: function(execEditParams)
            ...
            for diagonalPath = rooibos_reporters_mocha_max(execEditParams.minDiagonalToConsider, - execEditParams.editLength) to rooibos_reporters_mocha_min(execEditParams.maxDiagonalToConsider, execEditParams.editLength) step 2
